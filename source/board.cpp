...
#define RAND_64                                                                                                        \
    ((uint64_t)rand() | (uint64_t)rand() << 15 | (uint64_t)rand() << 30 | (uint64_t)rand() << 45 |                     \
...
const bool Board::PieceMin[13] = {false, false, true, true,  false, false, false,
...
// Piece Colours
const Colour Board::PieceCol[13] = {BOTH,  WHITE, WHITE, WHITE, WHITE, WHITE, WHITE,
                                    BLACK, BLACK, BLACK, BLACK, BLACK, BLACK};

// Piece Types
const bool Board::PieceKnight[13] = {false, false, true,  false, false, false, false,
                                     false, true,  false, false, false, false};
const bool Board::PieceKing[13] = {false, false, false, false, false, false, true,
                                   false, false, false, false, false, true};
const bool Board::PieceRookQueen[13] = {false, false, false, false, true, true, false,
                                        false, false, false, true,  true, false};
const bool Board::PieceBishopQueen[13] = {false, false, false, true,  false, true, false,
                                          false, false, true,  false, true,  false};
const bool Board::PieceSlides[13] = {false, false, false, true, true, true, false,
...
void Board::updateListsMaterial()
{
    for (int index = 0; index < TOTAL_SQUARES; ++index)
    {
        ...
        if (piece != EMPTY)
        {
            ...
            if (Board::PieceMin[piece] == true)
                m_minPce[colour]++;
            if (Board::PieceMaj[piece] == true)
                m_majPce[colour]++;
            ...
            if (piece == wK)
                m_kingSq[WHITE] = static_cast<Square>(sq);
            if (piece == bK)
                m_kingSq[BLACK] = static_cast<Square>(sq);
        }
    }
}
...
bool Board::checkBoard() const
{
    ...
    assert(m_ply < MAXDEPTH);
    assert(m_hisply < MAX_GAME_MOVES);
